...
import net.luis.common.dao.PropertyFilter.MatchType;
import net.luis.common.utils.Reflections;
 ...
 * @author liusai
 */
public class HibernateBaseDao<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> {
	/**
	 * 用于Dao层子类的构造函数.
